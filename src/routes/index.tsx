...
import mundyLogo from "@/assets/mundy/logo.svg";
...
const MAPS_URL = "https://www.google.com/maps/place/Mundy+Construtora/@-19.9370956,-43.9482836,17z/data=!3m1!4b1!4m14!1m7!3m6!1s0xa6977d2fbf3f63:0x4d4f58aa6af7b8!2sMundy+Construtora!8m2!3d-19.9371007!4d-43.9457087!16s%2Fg%2F11syyz0c1q!3m5!1s0xa6977d2fbf3f63:0x4d4f58aa6af7b8!8m2!3d-19.9371007!4d-43.9457087!16s%2Fg%2F11syyz0c1q?entry=ttu&g_ep=EgoyMDI2MDkxNi4wIKXMDSoASAFQAw%3D%3D";

const projects = [
  { brand: "Housi", name: "Alinea Contorno", neighborhood: "Santo Antônio / Lourdes", rooms: "1 e 2 quartos", area: "24 a 57m²", status: "75% vendido", stage: "Em construção", image: contornoImage },
  { brand: "Housi", name: "Alinea Sion", neighborhood: "Sion", rooms: "1 e 2 quartos", area: "24 a 43m²", status: "Pronto para rentabilizar", stage: "Pronto para morar", image: sionImage },
  { brand: null, name: "Residencial Lucca Fonseca", neighborhood: "Cruzeiro", rooms: "2 quartos", area: "74m²", status: "100% vendido", stage: "Pronto para morar", image: luccaImage },
  { brand: null, name: "Residencial Severo Quintino", neighborhood: "Sion", rooms: "1 e 2 quartos", area: "54 a 74m²", status: "Última unidade", stage: "Pronto para morar", image: severoImage },
];
...
function Differentials() {
  ...
  return <section id="diferenciais" className="bg-background py-20 lg:py-28"><div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10"><Reveal><p className="text-xs font-bold uppercase tracking-[0.22em] text-accent">Diferenciais</p><div className="mt-4 grid gap-8 lg:grid-cols-2"><h2 className="max-w-3xl font-display text-4xl uppercase leading-tight text-brand sm:text-5xl">Inovação,<br />sustentabilidade<br />e economia.</h2><div className="space-y-4 text-sm leading-relaxed text-brand/65 sm:text-base"><p>Criar formas inovadoras para reduzir o consumo de recursos naturais e manutenções em nossos edifícios — e, consequentemente, o valor da conta de seus moradores — sempre foi um ponto essencial para nós, da Mundy.</p><p>O resultado são taxas de condomínios econômicas, com cobranças individualizadas de água, gás e energia elétrica. Alguns edifícios possuem também energia fotovoltaica, tornando o condomínio ainda mais sustentável.</p><p>Além disso, nosso cliente sempre vai encontrar flexibilidade para negociar, fazer propostas e se surpreender com os valores extremamente competitivos para a qualidade do produto que entregamos.</p><p>Facilitamos seu acesso às melhores linhas de crédito disponíveis no mercado. Faça sua simulação com a Mundy.</p></div></div></Reveal><div className="mt-12 grid gap-px overflow-hidden rounded-[2rem] border bg-border sm:grid-cols-2 lg:grid-cols-4">{items.map(({ icon: Icon, title, text }, index) => <Reveal key={title} delay={index * .08} className="h-full bg-background p-7"><span className="grid size-12 place-items-center rounded-2xl bg-sage/35 text-brand"><Icon size={22} /></span><h3 className="mt-8 font-display text-2xl">{title}</h3><p className="mt-3 text-sm leading-relaxed text-brand/60">{text}</p></Reveal>)}</div></div></section>;
}
